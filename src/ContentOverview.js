          ...
          <Card style={{...styles.cardStyle,...styles.boxShadow}}>
            <CardBody style={styles.homeCardBody}>
              <div style={{display: 'flex', justifyContent: 'space-between'}}>
                ...
                <div>
                    {lesson.iconName? 
                        <img src={require('./assets/category-icons/' + lesson.iconName)} width='70px' height='70px' alt=''/>
                    :
              ...
              <div style={{display: 'flex', justifyContent: 'space-between'}}>
                ...
                <div style={{marginTop: '30px'}}>
                  <Button block color="light" onClick={this.handleClick.bind(this,"remix")} className='action-button'>
                    <FontAwesomeIcon icon="pencil-alt"/>
                    Remix
                  </Button>
                  <Button block color="light" onClick={this.handleClick.bind(this,"comments")} className='action-button'>
                    <FontAwesomeIcon icon="comment"/>
                    View Comments
                  </Button>
                  <Button block color="light" onClick={this.handleClick.bind(this,"flag")} className='action-button'>
