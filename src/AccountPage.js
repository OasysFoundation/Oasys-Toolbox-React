...
class AccountPage extends Component{
	constructor(props){
		...
		api.getUserContentsPreview(/*Markus Load current user UID from store*/)
            .then(json => 
            	this.setState({
						...
						<div>
							<section style={styles.HorizontalScrollOuterCenterContainer}>
								<div style={styles.HorizontalScrollContainer}>
							        ...
							        <div>
									{this.state.pageData.map(dataObj=>
											<HorizontalScroll key={dataObj.title} title={dataObj.title} data={dataObj.data} id={dataObj.id} icon={dataObj.icon}/>
									)}
									</div>
									</ScrollableAnchor>
