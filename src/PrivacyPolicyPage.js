...
class PrivacyPolicyPage extends Component {
    ...
    render() {
		...
		<p>Effective date: August 21, 2018</p>


		<p>Oasys Education Inc ("us", "we", or "our") operates the https://joinoasys.org website (hereinafter referred to as the "Service").</p>

		<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for Oasys Education Inc is powered by <a href="https://privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com</a>.</p>
		...
		<p>Oasys Education Inc uses the collected data for various purposes:</p>    
		<ul>
		...
		<p>Oasys Education Inc will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

		<h2>Disclosure Of Data</h2>

		<h3>Legal Requirements</h3>
		<p>Oasys Education Inc may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
		<ul>
		    <li>To comply with a legal obligation</li>
		    <li>To protect and defend the rights or property of Oasys Education Inc</li>
		...
		<ul>
        <li>By email: info@joinoasys.org</li>
            <li>By visiting this page on our website: https://joinoasys.org/privacy</li>
