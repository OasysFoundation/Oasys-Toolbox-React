...
class FooterPage extends React.Component {
    render(){
        return(
            <Footer color="blue-grey" className="page-footer font-small lighten-5 pt-1 mb-0 pb-3" style={{backgroundColor:"#f8f8f4"}}>
                <Container className="mt-5 text-center text-md-left">
                    <Row className="mt-3" style={{display:"flex", justifyContent:"center"}}>
                        ...
                        <Col md="3" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{width: '60px'}}/>
                            <p><a href="/explore" className="dark-grey-text">Home</a></p>
                        ...
                        <Col md="2" lg="2" xl="2" className="mb-4 dark-grey-text">
                            ...
                            <p><a href="https://github.com/OasysFoundation" className="dark-grey-text"><div style={{color:"rgba(0, 0, 0, 0.5)"}}><FontAwesomeIcon icon={['fab', 'github']} className="faAlignRight marginRight5" size="lg"/></div></a></p>
                            <p><a href="https://twitter.com/OasysOrg" className="dark-grey-text"><div style={{color:"rgba(0, 0, 0, 0.5)"}}><FontAwesomeIcon icon={['fab', 'twitter']} className="faAlignRight marginRight5" size="lg"/></div></a></p>
                            <p><a href="https://www.instagram.com/oasyseducation/" className="dark-grey-text"><div style={{color:"rgba(0, 0, 0, 0.5)"}}><FontAwesomeIcon icon={['fab', 'instagram']} className="faAlignRight marginRight5" size="lg"/></div></a></p>
                            </div>
                        </Col>
